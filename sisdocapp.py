...
names = ["Michel Daros", "Gustavo Pelissaro", "Alex Sandoval", "Alexsandra Mendes", "Marco Lamim", "Guilherme Grandesi", "Henrique Riego", "Rogerio Ishikawa", "David Andrade", "Fabiana Garcia", "Gabriela Souza", "Andre Hiroshi", "Rafael Pereira", "Gisele Duarte", "Bruna Rufino", "Hellen Vitali", "Rosana Bretzel", "Maria Araújo"]
...
# Configurar as credenciais de autenticação com emails placeholders
credentials = {
    "usernames": {
        usernames[0]: {"name": names[0], "email": "mdaros@placeholder.com", "password": hashed_passwords[0]},
        usernames[1]: {"name": names[1], "email": "gpelissaro@placeholder.com", "password": hashed_passwords[1]},
        usernames[2]: {"name": names[2], "email": "asandoval@placeholder.com", "password": hashed_passwords[2]},
        usernames[3]: {"name": names[3], "email": "amendes@placeholder.com", "password": hashed_passwords[3]},
        usernames[4]: {"name": names[4], "email": "mlamim@placeholder.com", "password": hashed_passwords[4]},
        usernames[5]: {"name": names[5], "email": "ggrandesi@placeholder.com", "password": hashed_passwords[5]},
        usernames[6]: {"name": names[6], "email": "hriego@placeholder.com", "password": hashed_passwords[6]},
        usernames[7]: {"name": names[7], "email": "rishikawa@placeholder.com", "password": hashed_passwords[7]},
        usernames[8]: {"name": names[8], "email": "dandrade@placeholder.com", "password": hashed_passwords[8]},
        usernames[9]: {"name": names[9], "email": "fgarcia@placeholder.com", "password": hashed_passwords[9]},
        usernames[10]: {"name": names[10], "email": "gsouza@placeholder.com", "password": hashed_passwords[10]},
        usernames[11]: {"name": names[11], "email": "ahiroshi@placeholder.com", "password": hashed_passwords[11]},
        usernames[12]: {"name": names[12], "email": "rpereira@placeholder.com", "password": hashed_passwords[12]},
        usernames[13]: {"name": names[13], "email": "gduarte@placeholder.com", "password": hashed_passwords[13]},
        usernames[14]: {"name": names[14], "email": "brufino@placeholder.com", "password": hashed_passwords[14]},
        usernames[15]: {"name": names[15], "email": "hvitali@placeholder.com", "password": hashed_passwords[15]},
        usernames[16]: {"name": names[16], "email": "rbretzel@placeholder.com", "password": hashed_passwords[16]},
        usernames[17]: {"name": names[17], "email": "maraujo@placeholder.com", "password": hashed_passwords[17]}
    }
}
